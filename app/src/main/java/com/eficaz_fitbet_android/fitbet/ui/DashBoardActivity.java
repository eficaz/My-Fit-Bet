...
import com.eficaz_fitbet_android.fitbet.presenter.DashBoardPresenter;
import com.eficaz_fitbet_android.fitbet.ui.fragments.ArchivesListFragment;
import com.eficaz_fitbet_android.fitbet.ui.fragments.BetFragment;
import com.eficaz_fitbet_android.fitbet.ui.fragments.DashBoardFragment;
import com.eficaz_fitbet_android.fitbet.ui.fragments.LiveBetFragment;
import com.eficaz_fitbet_android.fitbet.ui.fragments.SettingsFragment;
...
import static com.eficaz_fitbet_android.fitbet.utils.Contents.GALLERY_REQUEST_CODE;
...
mBottomNavigationView.setLabelVisibilityMode(LabelVisibilityMode.LABEL_VISIBILITY_LABELED);
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!AppPreference.getPrefsHelper().getPref(DASH_BOARD_POSICTION,"").equals("2")) {
                    live_bet = true;
    ...
    private void init() {
            ...
            switch (AppPreference.getPrefsHelper().getPref(Contents.DASH_BOARD_POSICTION, "")) {
    ...
    private void callLiveBetApi() {
        ...
        Call<ResponseBody> call = RetroClient.getClient(Constant.BASE_APP_URL).create(RetroInterface.class).LiveBetDetails(AppPreference.getPrefsHelper().getPref(Contents.REG_KEY,""));
