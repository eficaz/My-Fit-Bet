...
import com.eficaz_fitbet_android.fitbet.util.IabBroadcastReceiver;
import com.eficaz_fitbet_android.fitbet.util.IabHelper;
import com.eficaz_fitbet_android.fitbet.util.IabResult;
import com.eficaz_fitbet_android.fitbet.util.Inventory;
import com.eficaz_fitbet_android.fitbet.util.Purchase;
import com.eficaz_fitbet_android.fitbet.utils.Utils;

import butterknife.Bind;
import butterknife.ButterKnife;

public class CreditPurchaseActivity extends BaseActivity implements IabBroadcastReceiver.IabBroadcastListener
        {
    ...
    static final String SKU_GAS = "com.fitbet_test_product";
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";
        // Some sanity checks to see if the developer (that's you!) really followed the
        // instructions to run this sample (don't put these checks on your app!)
       /* if (base64EncodedPublicKey.contains("CONSTRUCT_YOUR")) {
            throw new RuntimeException("Please put your app's public key in MainActivity.java. See README.");
        }
        if (getPackageName().startsWith("com.eficaz_android.fitbet")) {
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(CreditPurchaseActivity.this);
                ...
                if (Utils.isConnectedToInternet(CreditPurchaseActivity.this)) {
                    if (!total_am.getText().toString().equals("0")) {
                        if (checkBox.isChecked()) {
                            ...
                            String payload = "";
                            try {
                                mHelper.launchPurchaseFlow(CreditPurchaseActivity.this, SKU_GAS, RC_REQUEST, mPurchaseFinishedListener, payload);
                            } catch (IabHelper.IabAsyncInProgressException e) {
                                complain("Error launching purchase flow. Another async operation in progress.");
                                setWaitScreen(false);
                            }
                        } else {
                            Utils.showCustomToastMsg(CreditPurchaseActivity.this, R.string.please_agreed_terms_condition);
                        }
                    } else {
                        Utils.showCustomToastMsg(CreditPurchaseActivity.this, R.string.please_choose_credit);
                    }
    ...
    public void updateUi() {
        ...
        ((ImageView)findViewById(R.id.free_or_premium)).setImageResource(mIsPremium ? R.drawable.coins : R.drawable.coins);
        ...
        if (mSubscribedToInfiniteGas) {
            ...
            infiniteGasButton.setImageResource(R.drawable.coins);
        } else {
        ...
        if (mSubscribedToInfiniteGas) {
            ((ImageView)findViewById(R.id.gas_gauge)).setImageResource(R.drawable.coins);
        }
        else {
