...
/**
 * Created by NickX on 24-02-2016.
 */
public class PermissionDialogFragment extends DialogFragment {
    ...
    /**
     * Creates a new {@link PermissionDialogFragment}. Only intended to be used by
     * {@link PermissionUtils#showRationaleInDialog(String, String, String, PermissionUtils.IOnRationaleProvided)}.
     *
     ...
     * @return A new {@link PermissionDialogFragment}.
     */
    public static PermissionDialogFragment newInstance(@Nullable String title, @NonNull String message, @Nullable String buttonText) {
