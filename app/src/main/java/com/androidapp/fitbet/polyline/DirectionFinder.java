...
public class DirectionFinder {
    ...
    private static final String DISTANCE_MATRIX_DIRECTION_URL = "https://maps.googleapis.com/maps/api/directions/json?mode=driving";
    private static final String GOOGLE_DIRECTION_API_KEY = "AIzaSyDprgIGxT3UqTDoROqfQ2BqHBRfKdOD0oQ";  // replace with your google direction api
