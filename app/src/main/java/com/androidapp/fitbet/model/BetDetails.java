...
public class BetDetails {
    ...
    public String getDistance_participants() {
        return distance_participants;
    }

    public void setDistance_participants(String distance_participants) {
        this.distance_participants = distance_participants;
    }
