package com.androidapp.fitbet.camera;
...
public class CameraGalleryPickerBottom extends BottomSheetDialogFragment implements View.OnClickListener {


    CommonUsage commonUsage;

    public static CameraGalleryPickerBottom newInstance() {
        return new CameraGalleryPickerBottom();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.camera_gallery_selection_bottom, container, false);
